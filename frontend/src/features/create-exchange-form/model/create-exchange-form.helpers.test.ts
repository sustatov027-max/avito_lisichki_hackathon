...
const LAPTOP_RAM_ATTRIBUTE_ID = '00000000-0000-4000-8000-000000000004'

const SMARTPHONES_CATEGORY_ID = '00000000-0000-0000-0000-000000000101'
const LAPTOPS_CATEGORY_ID = '00000000-0000-0000-0000-000000000102'
...
describe('getCategoryDefaultAttributes', () => {
	...
	it('uses a single optional value for every offered range attribute', () => {
		const attributes = getCategoryDefaultAttributes(
			LAPTOPS_CATEGORY_ID,
			'offered'
		)
